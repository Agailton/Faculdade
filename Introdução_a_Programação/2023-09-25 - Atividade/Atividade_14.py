...
#Questão: Escreva um programa que dê descontos de acordo com o valor da compra: acima de R$100, desconto de 10%; 
#entre R$50 e R$100, desconto de 5%; abaixo de R$50, sem desconto. Calcule e mostre o valor do desconto e o valor 
#total a pagar.
...
print(f'O valor total a pagar é {valor_da_compra}')